...
export default class YTDlpWrap {
    ...
    static downloadFile(fileURL: string, filePath: string, onProgress?: (progress: number, downloaded: number, total: number) => void): Promise<IncomingMessage | undefined>;
    static getGithubReleases(page?: number, perPage?: number): Promise<any>;
    static downloadFromGithub(filePath?: string, version?: string, platform?: NodeJS.Platform, onProgress?: (progress: number, downloaded: number, total: number) => void, build?: 'stable' | 'nightly' | 'master'): Promise<void>;
